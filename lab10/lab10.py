...
plot_embedding(X_pca,
               "Principal Components projection of the data (time %.2fs)" %
               (time() - t0))
...
plot_embedding(X_lda,
               "Linear Discriminant projection of the data (time %.2fs)" %
               (time() - t0))
...
plot_embedding(X_iso,
               "Isomap projection of the data (time %.2fs)" %
               (time() - t0))
...
plot_embedding(X_lle,
               "Locally Linear Embedding of the data (time %.2fs)" %
               (time() - t0))
...
plot_embedding(X_mlle,
               "Modified Locally Linear Embedding of the data (time %.2fs)" %
               (time() - t0))
...
plot_embedding(X_ltsa,
               "Local Tangent Space Alignment of the data (time %.2fs)" %
               (time() - t0))
...
plot_embedding(X_reduced,
               "Random forest embedding of the data (time %.2fs)" %
               (time() - t0))
...
plot_embedding(X_se,
               "Spectral embedding of the data (time %.2fs)" %
               (time() - t0))
